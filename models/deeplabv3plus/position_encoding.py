...
class PositionEmbeddingSine(nn.Module):
    ...
    """
    def __init__(self, num_pos_feats=128, num_frames = 36, temperature=10000, normalize=False, scale=None):
        super().__init__()
    ...
    def forward(self, tensor):
        #batch frame channel height width -> batch frame height width
...
if __name__ == "__main__":
    nn=PositionEmbeddingSine()
    a = torch.randn((2,12,64,256,256))
    print(nn(a).shape)
